...
public class TrainingRestController {
    ...
    public ResponseEntity<?> deleteTraining(@PathVariable Long trainingId,
                                            ...
                                            @RequestParam String trainerPassword) {
        String txId = generateTxId();
        logger.info("[{}] DELETE /api/trainings/{} by trainer={}",
                txId, trainingId, trainerUsername);
        ...
        try {
            gymFacade.cancelTraining(trainingId);
            return ResponseEntity.ok("Training cancelled");
        } catch (IllegalArgumentException ex) {
